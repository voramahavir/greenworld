      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <a onclick="AddTheRow()" class="btn btn-info">
      ...
      <div class="modal fade modal-3d-flip-horizontal" id="addNurseryModal" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              <form id="nursery" method="post" enctype="multipart/form-data">
...
<script src="<?php echo base_url('assets/theme/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js'); ?>"></script>
    ...
    function EditTheRow(index,id){
      window.location.href = "<?php echo site_url('nursery/edit/'); ?>"+id;
    }
    function AddTheRow(){
    ...
    $("form#nursery").submit(function(e) {
        e.preventDefault();    
