        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"> Nursery Banners </h3>
            </div>
            <div class="box-body">
                <div class="dataTables_wrapper">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <table class="table table-bordered table-hover dataTable" id="table_nurserybanners">
                        <thead>
                          <tr>
                            <th>Image</th>
                            <th>Action</th>
...
<script src="<?php echo base_url('assets/theme/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js'); ?>"></script>
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        table = $('#table_nurserybanners').DataTable({
          "paging": true,
          "lengthChange": true,
          "searching": false,
          "ordering": true,
          ...
          "pageLength": 10,
          "ajax": {
            "url": "<?php echo site_url('nurserybanners/get'); ?>",
            "type": "POST"
          },
          "columns": [
              { 
    ...
    $(".deleteBanner").on("click",function(){
        ...
        $.post("<?php echo site_url('nurserybanners/delete/'); ?>"+id,{})
    ...
    $(".recoverBanner").on("click",function(){
        ...
        $.post("<?php echo site_url('nurserybanners/recover/'); ?>"+id,{})
        .done(function(result){
            result=JSON.parse(result);
            if(result.success==true){
                table.ajax.reload();
    ...
    function submitAddForm(form) {
        ...
        $.ajax({
            url: "<?php echo site_url('nurserybanners/add'); ?>",
            type: 'POST',
            data: formData,
    ...
    function submitEditForm(form) {
        var formData = new FormData(form);
        $.ajax({
            url: "<?php echo site_url('nurserybanners/edit/');?>"+id,
            type: 'POST',
            data: formData,
            success: function (data) {
              data = JSON.parse(data);
